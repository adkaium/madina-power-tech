    ...
    <section className='section bg-newsletter min-h-[490px]' id='contact'>
      <div className="container mx-auto flex justify-center lg:justify-end ">
        <div className='w-full max-w-[558px] text-center text-white lg:text-left'>
          ...
          <p
          className='text-xl font-light mb-10'>{subtitle}</p>
          <div className='flex flex-col lg:flex-row gap-[22px]'>
            <input className='h-[60px] px-6 outline-none placeholder:text-gray-400 text-gray-600 rounded-lg lg:flex-1' type="text" placeholder={placeholder}/>
